...
**Source release/branch:** [v0.5.7](https://github.com/dbarjs/devcontainer-images/tree/v0.5.7/src/node-extras)
...
**Digest:** sha256:cc5a04a279ed9f295b351a72a904be8e45cb23a3c1cb3bbaf54a1569a6b20136

**Tags:**
```
docker.io/dbarjs/node-extras-devcontainer:0.5.4-current
...
docker.io/dbarjs/node-extras-devcontainer:0.5.4
docker.io/dbarjs/node-extras-devcontainer:0.5.4-21
docker.io/dbarjs/node-extras-devcontainer:0.5.4-21-bookworm
docker.io/dbarjs/node-extras-devcontainer:0.5.4-bookworm
docker.io/dbarjs/node-extras-devcontainer:0.5.4-current
docker.io/dbarjs/node-extras-devcontainer:0.5.4-current-bookworm
docker.io/dbarjs/node-extras-devcontainer:0.5.4-latest
```
...
**Digest:** sha256:23b678bf56595a1db00fb7566d4172825bbb278474543c09d06c9a2d1fdcf42b

**Tags:**
```
docker.io/dbarjs/node-extras-devcontainer:0.5.4-lts
...
docker.io/dbarjs/node-extras-devcontainer:0.5.4-20
docker.io/dbarjs/node-extras-devcontainer:0.5.4-20-bookworm
docker.io/dbarjs/node-extras-devcontainer:0.5.4-iron
docker.io/dbarjs/node-extras-devcontainer:0.5.4-iron-bookworm
docker.io/dbarjs/node-extras-devcontainer:0.5.4-lts
docker.io/dbarjs/node-extras-devcontainer:0.5.4-lts-iron
docker.io/dbarjs/node-extras-devcontainer:0.5.4-lts-bookworm
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
