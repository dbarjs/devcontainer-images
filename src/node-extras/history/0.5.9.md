...
**Source release/branch:** [v0.5.9](https://github.com/dbarjs/devcontainer-images/tree/v0.5.9/src/node-extras)
...
**Digest:** sha256:b308af6d61685feed93bcab58819b627aca2518cb64e6f6f00b033e969ea44e8

**Tags:**
```
docker.io/dbarjs/node-extras-devcontainer:0.5.9-current
...
docker.io/dbarjs/node-extras-devcontainer:0.5.9
docker.io/dbarjs/node-extras-devcontainer:0.5.9-21
docker.io/dbarjs/node-extras-devcontainer:0.5.9-21-bookworm
docker.io/dbarjs/node-extras-devcontainer:0.5.9-bookworm
docker.io/dbarjs/node-extras-devcontainer:0.5.9-current
docker.io/dbarjs/node-extras-devcontainer:0.5.9-current-bookworm
docker.io/dbarjs/node-extras-devcontainer:0.5.9-latest
```
...
**Digest:** sha256:218594217d8e560760c20cdfe635286e35115ad89b5cb5dbb87b405179bd2b46

**Tags:**
```
docker.io/dbarjs/node-extras-devcontainer:0.5.9-lts
...
docker.io/dbarjs/node-extras-devcontainer:0.5.9-20
docker.io/dbarjs/node-extras-devcontainer:0.5.9-20-bookworm
docker.io/dbarjs/node-extras-devcontainer:0.5.9-iron
docker.io/dbarjs/node-extras-devcontainer:0.5.9-iron-bookworm
docker.io/dbarjs/node-extras-devcontainer:0.5.9-lts
docker.io/dbarjs/node-extras-devcontainer:0.5.9-lts-iron
docker.io/dbarjs/node-extras-devcontainer:0.5.9-lts-bookworm
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
