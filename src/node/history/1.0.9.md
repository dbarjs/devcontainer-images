...
**Source release/branch:** [v0.6.8](https://github.com/dbarjs/devcontainer-images/tree/v0.6.8/src/node)
...
**Digest:** sha256:eb91e3ee2cb6e6a26ef4a0eec2e5e1debe830089a06a6a96b6a8416521ab00cf

**Tags:**
```
docker.io/dbarjs/node-devcontainer:1.0.9-current
docker.io/dbarjs/node-devcontainer:1.0.9-current
docker.io/dbarjs/node-devcontainer:1.0.9
```
...
**Digest:** sha256:ea9e78cb507812ded4cd55e152d55414ef4637a0d756084c0fa2f90da70dbf95

**Tags:**
```
docker.io/dbarjs/node-devcontainer:1.0.9-lts
docker.io/dbarjs/node-devcontainer:1.0.9-lts
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
