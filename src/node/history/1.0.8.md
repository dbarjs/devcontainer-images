...
**Source release/branch:** [v0.6.7](https://github.com/dbarjs/devcontainer-images/tree/v0.6.7/src/node)
...
**Digest:** sha256:092ce0277f27bd349aab9b9f111f44d623bb1a4ec637e6d5489efc11c1afebbd

**Tags:**
```
docker.io/dbarjs/node-devcontainer:1.0.8-current
docker.io/dbarjs/node-devcontainer:1.0.8-current
docker.io/dbarjs/node-devcontainer:1.0.8
```
...
**Digest:** sha256:4c1e81a7eb71e950fa3c1d6a92dd9f94f3b0d77dfbd64115f3505aeed1273fd3

**Tags:**
```
docker.io/dbarjs/node-devcontainer:1.0.8-lts
docker.io/dbarjs/node-devcontainer:1.0.8-lts
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
