...
**Source release/branch:** [v0.5.9](https://github.com/dbarjs/devcontainer-images/tree/v0.5.9/src/vue)
...
**Digest:** sha256:f8df9bd9280a451ac5b2d7e0f8e6f6cc8a5d6f051810e1adcc0bdd3e682a4699

**Tags:**
```
docker.io/dbarjs/vue-devcontainer:0.5.9-current
...
docker.io/dbarjs/vue-devcontainer:0.5.9
docker.io/dbarjs/vue-devcontainer:0.5.9-21
docker.io/dbarjs/vue-devcontainer:0.5.9-21-bookworm
docker.io/dbarjs/vue-devcontainer:0.5.9-bookworm
docker.io/dbarjs/vue-devcontainer:0.5.9-current
docker.io/dbarjs/vue-devcontainer:0.5.9-current-bookworm
docker.io/dbarjs/vue-devcontainer:0.5.9-latest
```
...
**Digest:** sha256:4e3b924606b81bd77179c70f3a778d0d2e79b4aab1e9b05f24de53116154937c

**Tags:**
```
docker.io/dbarjs/vue-devcontainer:0.5.9-lts
...
docker.io/dbarjs/vue-devcontainer:0.5.9-20
docker.io/dbarjs/vue-devcontainer:0.5.9-20-bookworm
docker.io/dbarjs/vue-devcontainer:0.5.9-iron
docker.io/dbarjs/vue-devcontainer:0.5.9-iron-bookworm
docker.io/dbarjs/vue-devcontainer:0.5.9-lts
docker.io/dbarjs/vue-devcontainer:0.5.9-lts-iron
docker.io/dbarjs/vue-devcontainer:0.5.9-lts-bookworm
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
