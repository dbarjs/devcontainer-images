...
**Source release/branch:** [v0.5.7](https://github.com/dbarjs/devcontainer-images/tree/v0.5.7/src/base-node)
...
**Digest:** sha256:f7bf459da7ff2a0cb723050906490b746e05f254f389f4c8568081eb565ee306

**Tags:**
```
docker.io/dbarjs/base-node-devcontainer:0.5.7-current
...
docker.io/dbarjs/base-node-devcontainer:0.5.7
docker.io/dbarjs/base-node-devcontainer:0.5.7-21
docker.io/dbarjs/base-node-devcontainer:0.5.7-21-bookworm
docker.io/dbarjs/base-node-devcontainer:0.5.7-bookworm
docker.io/dbarjs/base-node-devcontainer:0.5.7-current
docker.io/dbarjs/base-node-devcontainer:0.5.7-current-bookworm
docker.io/dbarjs/base-node-devcontainer:0.5.7-latest
```
...
**Digest:** sha256:b7e763cd9f80d667e2f8fb5ca42036e1c62f6feb3a54ec0a7853f714ed98f5f8

**Tags:**
```
docker.io/dbarjs/base-node-devcontainer:0.5.7-lts
...
docker.io/dbarjs/base-node-devcontainer:0.5.7-20
docker.io/dbarjs/base-node-devcontainer:0.5.7-20-bookworm
docker.io/dbarjs/base-node-devcontainer:0.5.7-iron
docker.io/dbarjs/base-node-devcontainer:0.5.7-iron-bookworm
docker.io/dbarjs/base-node-devcontainer:0.5.7-lts
docker.io/dbarjs/base-node-devcontainer:0.5.7-lts-iron
docker.io/dbarjs/base-node-devcontainer:0.5.7-lts-bookworm
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
