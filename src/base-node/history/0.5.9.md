...
**Source release/branch:** [v0.5.9](https://github.com/dbarjs/devcontainer-images/tree/v0.5.9/src/base-node)
...
**Digest:** sha256:edcdd403f1b6eee6e69435d3f2e0692406dd4aaee25111bdb2b33b49df04a168

**Tags:**
```
docker.io/dbarjs/base-node-devcontainer:0.5.9-current
...
docker.io/dbarjs/base-node-devcontainer:0.5.9
docker.io/dbarjs/base-node-devcontainer:0.5.9-21
docker.io/dbarjs/base-node-devcontainer:0.5.9-21-bookworm
docker.io/dbarjs/base-node-devcontainer:0.5.9-bookworm
docker.io/dbarjs/base-node-devcontainer:0.5.9-current
docker.io/dbarjs/base-node-devcontainer:0.5.9-current-bookworm
docker.io/dbarjs/base-node-devcontainer:0.5.9-latest
```
...
**Digest:** sha256:22cebdc94ce28f7f24c0309fe90836b109c6fc6490d5714946e3d6546eb6233d

**Tags:**
```
docker.io/dbarjs/base-node-devcontainer:0.5.9-lts
...
docker.io/dbarjs/base-node-devcontainer:0.5.9-20
docker.io/dbarjs/base-node-devcontainer:0.5.9-20-bookworm
docker.io/dbarjs/base-node-devcontainer:0.5.9-iron
docker.io/dbarjs/base-node-devcontainer:0.5.9-iron-bookworm
docker.io/dbarjs/base-node-devcontainer:0.5.9-lts
docker.io/dbarjs/base-node-devcontainer:0.5.9-lts-iron
docker.io/dbarjs/base-node-devcontainer:0.5.9-lts-bookworm
```
> *To keep up to date, we recommend using partial version numbers. Use the major version number to get all non-breaking changes (e.g. `0-`) or major and minor to only get fixes (e.g. `0.200-`).*
